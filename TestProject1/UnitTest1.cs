namespace TestProject1
{
    ...
    public class UnitTest1
    {
        ...
        {
            Order.MyOrders.Order order = new Order.Order("we",2345512388456,45,"ff");
        ...
        {
            Order.MyOrders.Order order = new Order.Order("we", 23455123886, 45, "ff");
        ...
        {
            Order.MyOrders.Order order = new Order.Order("ee",232323,-6,"ww");
